...
@SpringBootTest(classes = { AccountServicePracticumBankApplication.class,
...
public abstract class BaseContractTest {
        ...
        public void setup() {
                ...
                UsernamePasswordAuthenticationToken auth = new UsernamePasswordAuthenticationToken(jwt,
                                jwt.getTokenValue(), List.of());
